...
Before continuing with later feature phases, [the Apple detector demo dataset](docs/apple-detector-demo.md) provides one complete, publicly licensed dataset for exercising the existing workflow end to end.
